...
for i in range (0,128):
	...
	fuel[i] .set_density( 'g/cm3' , 13.630000 )
	fuel[i] .add_element( 'C' , 0.048049 , 'wo' )
	fuel[i] .add_nuclide( 'U234' , 0.000254, 'wo' )
	fuel[i] .add_nuclide( 'U235' , 0.11423412 , 'wo' )
	fuel[i] .add_nuclide( 'U236' , 0.000131 , 'wo' )
	fuel[i] .add_nuclide( 'U238' , 0.83733188, 'wo' )
...
for i in range (128,144):
	...
	fuel[i].add_element( 'C' , 0.048049 , 'wo' )
	fuel[i].add_nuclide( 'U234' , 0.000254 , 'wo' )
	fuel[i].add_nuclide( 'U235' , 0.07615608 , 'wo' )
	fuel[i].add_nuclide( 'U236' , 0.000131 , 'wo' )
	fuel[i].add_nuclide( 'U238' , 0.87540992 , 'wo' )
...
for i in range (144,160):
	...
	fuel[i].add_element( 'C' , 0.048049 , 'wo' )
	fuel[i].add_nuclide( 'U234' , 0.000254 , 'wo' )
	fuel[i].add_nuclide( 'U235' , 0.061876815 , 'wo' )
	fuel[i].add_nuclide( 'U236' , 0.000131 , 'wo' )
	fuel[i].add_nuclide( 'U238' , 0.889689185 , 'wo' )
...
'''
, step1_2,step1_3, step1_4, step1_5, step_1,step_2,step_3,step_4,step_5,step_6,step_7,step_8,step_9,step_10]
#step_41,step_42,step_43,step_44,step_45,step_46,step_47,step_48,step_49,step_50,step_51,step_52,step_53,step_54,step_55,step_56,step_57,step_58,step_59,step_60]




import openmc.deplete.operator
max_step = 2 * (operator.heavy_metal/1e3) / 600 
max_step
'''
